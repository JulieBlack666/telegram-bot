...
class CommandParser extends RegexParsers {
  ...
  def createPoll: Parser[Command] = {
    ...
    ("^/create_poll".r ~> "(" ~> pollName <~ ")") ~ anonimity.? ~ continuous.? ~ startTime.? ~ stopTime.? <~ "$".r ^^ { s =>
      CreatePoll(s._1._1._1._1, s._1._1._1._2, s._1._1._2,
        s._1._2, s._2)
    }
  }
  ...
  def answerQuestionChoiceMulti: Parser[Command] = "^/answer".r ~> ("(" ~> """\d+""".r <~ ")") ~ ("(" ~> rep("""\d+""".r) <~ ")") ^^ { x => AnswerQuestionChoiceMulti(x._1.toInt, x._2) }
